...
import { TranslationItem, RecentActivityItem, TranslationCategory } from './types';
...
function App() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(`Translation service error: ${errorMessage}. You can still use historical data or suggest a term.`);
    }
  ...
  const submitUserSuggestion = (e: React.FormEvent) => {
    ...
    const category = TranslationCategory.USER;
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
      ...
      <main className="flex-grow flex flex-col items-center max-w-6xl mx-auto w-full px-2 py-6 md:px-4 md:py-8">
        ...
        {/* Error Message */}
        {error && (
          <div className="w-full max-w-2xl mx-4 mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
